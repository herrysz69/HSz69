...
def NOTIFIED_ADD_CONTACT(op):
    try:
        sendMessage(op.param1, client.getContact(op.param1).displayName + "Terima kasih sudah add saya")
...
def NOTIFIED_KICKOUT_FROM_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param3).displayName + " Rip\n(*´･ω･*)")
    except Exception as e:
        print e
...
def NOTIFIED_LEAVE_GROUP(op):
    try:
        sendMessage(op.param1, client.getContact(op.param2).displayName + " Rip\n(*´･ω･*)")
    except Exception as e:
        print e
...
#------Protect Group Kick finish-----#
            ...
            if msg.text in ["Mention","Tagall"]:
                 ...
                 if msg.contentType = 0
                 if msg.text = cb2
                 if msg.contentMetadata ={'MENTION':'{"MENTIONEES":['+cb+']}','EMTVER':'4'}
